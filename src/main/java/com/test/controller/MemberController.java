...
public class MemberController {
	...
	@RequestMapping(value="/customer_modify",method=RequestMethod.GET)
	...
	@RequestMapping(value="/customer_modify",method=RequestMethod.POST)
	  public String customer_modify(CustomerDTO cust) {
