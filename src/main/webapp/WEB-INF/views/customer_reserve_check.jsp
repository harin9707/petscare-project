		...
		<nav class="menu navbar navbar-expand-lg navbar-light" id="top">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a class="nav-link" href="search">업체찾기</a>
					</li>
		...
		<div class="row mx-auto main-container">
			<div class="mx-auto main-block   col-12">
				<section>
					...
					<form method="get" action="" id="cancelOrReview">
						<table class="table text-center">
							...
							<c:forEach items="${ reservation }" var="reservation"
								...
								<tr>
									<td class="ff${ counter.count }">${ reservation.reservation_Index }</td>
									...
									<td><c:if
											...
											<input type="button"
												onclick="isReviewOrCancel(this, ${counter.count});"
												id="cancelButton" class="btn btn-outline-danger" value="취소">
										</c:if></td>
									<td><c:if
											test="${reservation.reservation_Check eq 'reserved'}">
											<input type="button"
												onclick="isReviewOrCancel(this, ${counter.count});"
												id="reviewButton" class="btn btn-outline-primary"
												value="후기작성">
										</c:if></td>
								</tr>
							</c:forEach>
