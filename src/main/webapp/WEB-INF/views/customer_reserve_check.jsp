                ...
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home"
                           role="tab"
                           aria-controls="v-pills-home" aria-selected="true">예약</a>
                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
                           role="tab"
                           aria-controls="v-pills-profile" aria-selected="false">취소예약</a>
                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages"
                           role="tab"
                           aria-controls="v-pills-messages" aria-selected="false">완료 예약</a>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <table class="table">
                                ...
                                <tbody>
	                                <c:forEach items="${ reservation }" var="reservation" varStatus="counter">      
	                             	   <c:if test="${reservation.reservation_Check eq 'reserved'}">                         	
			                                <tr>		                                
			                                    ...
			                                    <td>
			                                        <button class="btn" onclick="location.href='customer_reservation_cancel?index='+${ reservation.reservation_Index }"><i class="fas fa-trash"></i></button>			                                        
			                                    </td>
			                                </tr>
		                                </c:if>
	                                </c:forEach>
