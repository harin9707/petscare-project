		...
		<div class="row mx-auto main-container">
			<div class="mx-auto main-block   col-12">
				<section>
					...
					<form method="POST" action="review_add_customer" accept-charset="utf-8" name="reservation" class="reserve-content text-center ">
						<table class="table table-hover">
							...
							<c:forEach items="${ reservation }" var="reservation">						 
								<tr>
									...
									<td><input type="hidden" name="reservation_Index" value="${reservation.reservation_Index}"/>
									<td>
										<input type="submit" class="btn btn-outline-primary" value="후기작성">
									</td>
								</tr>
