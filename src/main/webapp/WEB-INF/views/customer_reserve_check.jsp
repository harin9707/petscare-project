			...
			<section>
				...
				<table class="table text-center">
					...
					<c:forEach items="${ reservation }" var="reservation">
						...
						<form method="get" action="customer_reservation_cancel">
							<tr>
								<td><input type="text" class="border-0 bg-white font-weight-bold text-center"
								...
								<td><c:if test="${reservation.reservation_Check eq 'reserved'}">
