...
<div class="container-fluid signup m-auto" style="max-width: 800px;">
      ...
      <div class="mt-3 mb-3">
            <div class="custom-control custom-radio custom-control-inline">
                <input value="개인회원" type="radio" id="customRadioInline1" name="userType" class="custom-control-input"
                checked>
                <label class="custom-control-label" for="customRadioInline1">개인회원</label>
            </div>

            <div class="custom-control custom-radio custom-control-inline">
                <input value="기업회원" type="radio" id="customRadioInline2" name="userType" class="custom-control-input">
                <label class="custom-control-label" for="customRadioInline2">기업회원</label>
            </div>
