            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="index.html">í <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container-fluid">
        <div class="row mx-auto main-container">
            <div class="col-10 mx-auto main-block">
                ...
                <h1>íìê°ì ìë£</h1>
                <p>ë°ê°ìµëë¤! ë°ë ¤ëë¬¼ì ìí ìë¹ì¤ë¥¼ ì í¬ì í¨ê» ì´ì©í´ë³´ì¸ì.</p>
                <hr>
                <a class="btn btn-lg btn-secondary mx-auto" href="login.html" role="button">Login</a>
            </div>
        </div>
    </main>
