	...
	<main class="container-fluid">
		<div class="row mx-auto main-container">
			<div class="col-10 mx-auto main-block">
				<div class="left-div">
					<img id="company_Image" src="./images/profile.png">

				</div>
				<div class="right-div">
						<h3 id="company_Name">${ company.company_Name }</h3>
						<p class="company-detail">
							<label id="company_UserName">${ company.company_UserName }</label><br>
							<label id="company_Address">${company.company_Address}</label><br>
							<label id="company_Email">${company.company_Email}</label><br>
							<label id="company_UserPhoneNumber">${company.company_UserPhoneNumber}</label><br>
							<label id="company_Number">${company.company_Number}</label><br>
						</p>
				</div>
			</div>
		</div>
