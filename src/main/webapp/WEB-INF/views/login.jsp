...
<body>
	...
	<div class="container-fluid login">
		...
		<form class="indi-form" action="loginDo" name="loginform"
			method="post">
			<table class="userid-table" align="center" height="40" width="430"
				border="0">
				<tr>
			...
			<table class="password-table" align="center" height="40" width="430"
				border="0">
				<tr>
			...
			<table align="center" height="10" class="link-table">
				<tr>
